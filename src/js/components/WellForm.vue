...
<script>
    ...
    export default {
        ...
        created() {
            ...
            // this.well = well1;
            let well3 = new Well("Well 3", 50, 1500, 0.03, 1.72, 1.327, 583.5, 65, 262, 415.51, 15.4, 0.33, 44, 991, "Exponential", 50, 70, 12, 0, 0, 0, 5, 6, 0, 1, 1, 0, 0, 5,5,[1000000,1000000,1000000],[{'value': 10}, {'value': 20}, {'value': 30},{'value': 40},{'value': 50}], 5,4,55, 0, 10, 10,[{'value': 54},{'value': 6},{'value': 66},{'value': 52},{'value': 55}]);
            let well4 = new Well("Well 4", 30, 1500, 0.03, 1.4, 0.317, 241.3, 110, 165, 415.51, 13.2, 2, 44, 825, "Exponential", 50, 70, 12, 0, 0, 0, 4, 6, 0, 1, 0, 0, 0, 4,5,[1000000,1000000,1000000],[{'value': 10}, {'value': 20}, {'value': 30},{'value': 40},{'value': 50}], 5,4,55, 0, 10, 10,[{'value': 54},{'value': 6},{'value': 66},{'value': 52},{'value': 55}]);
